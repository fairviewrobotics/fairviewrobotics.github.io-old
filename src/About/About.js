    ...
    return (
      <div>
        ...
        <div className="about-outer">
          <img src={comp2017_20} style={{ marginTop: '-0.5vw' }} className="about-img left"/>
          ...
          <img src={comp2017_11} className="about-img right"/>
          ...
          <img src={build2017_5} className="about-img left"/>
          ...
          <img src={comp2016_7} style={{ marginTop: '2.5vh' }} className="about-img right"/>
          ...
          <img src={build2017_2} className="about-img left"/>
